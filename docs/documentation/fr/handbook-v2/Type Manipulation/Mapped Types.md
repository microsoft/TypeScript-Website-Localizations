...
title: Types Mappés
layout: docs
permalink: /fr/docs/handbook/2/mapped-types.html
oneline: "Générer des types en réutilisant certains types"
---

Pour éviter les redondances et les répétitions, un type a parfois besoin d'être basé sur un autre type.
