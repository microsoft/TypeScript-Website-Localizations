export const docCopy = {
  ...
  doc_bootstrap_title: "TypeScript项目引导工具",
  doc_bootstrap_description:
      "用于构建cli、Web应用程序、api和应用程序的工具链.",
  doc_headline: "开始学习",
  ...
  doc_headline_examples_blurb: "全面的演练场实践教程",
  ...
  doc_tooling_vite_blurb: "下一代前端开发与构建工具",
  ...
  doc_cheatsheets_subnav_title: "速查表",
  doc_learn_cheatsheets_blurb: "TypeScript语法概览",
}
