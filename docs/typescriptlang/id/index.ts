...
<p>Penulisan tipe dapat bersifat opsional di TypeScript, karena inferensi tipe memungkinkan Anda mendapatkan banyak daya tanpa menulis kode tambahan.</p>`,
  ...
  index_trust_copy_b: `Kode TypeScript diubah menjadi kode JavaScript melalui penyusun TypeScript atau <babel>Babel</babel>. JavaScript ini bersih, kode sederhana yang berjalan di mana saja JavaScript dijalankan: Di peramban, di Node.JS atau di aplikasi Anda.`,
  ...
  <p>Misalnya, tim TypeScript memperjuangkan proposal seperti Optional Chaining, Nullish coalescing Operator, Throw Expressions, dan Indeks Pencocokan RegExp.</p>`,
...
<p>Inferensi tipe TypeScript berarti Anda tidak perlu membuat anotasi kode sampai Anda menginginkan keamanan lebih.</p>`,
